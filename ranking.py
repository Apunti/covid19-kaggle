...
class Ranking:
    ...
    def _get_dictionaries(self):
        ...
        if self.data == 'abstracts':
            with open('Data/ranking_dict/document_frequencies_abstract_v8.p', 'rb') as fp:
                self.document_frequencies = pickle.load(fp)

            with open('Data/ranking_dict/term_frequencies_abstract_v8.p', 'rb') as fp:
                self.term_frequencies = pickle.load(fp)

            with open('Data/ranking_dict/document_length_abstract_v8.p', 'rb') as fp:
